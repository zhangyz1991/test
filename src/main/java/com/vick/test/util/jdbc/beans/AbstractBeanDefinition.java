...
import com.vick.test.util.jdbc.framework.io.DescriptiveResource;
...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
     ...
     * status unless overridden from a parent beans definition (if applicable).
     */
     ...
     * {@link #setDestroyMethodName destroy method name} for a beans as opposed to
     * explicit specification of a method name. The value {@value} is specifically
     * designed to include characters otherwise illegal in a method name, ensuring
     * no possibility of collisions with legitimately named methods having the same
     * name.
     * <p>Currently, the method names detected during destroy method inference
     * are "close" and "shutdown", if present on the specific beans class.
     */
     ...
     * beans definition.
     * @param original the original beans definition to copy from
     */
    ...
    /**
     * Override settings in this beans definition (presumably a copied parent
     * from a parent-child inheritance relationship) from the given beans
     * definition (presumably the child).
     * <ul>
     * <li>Will override beanClass if specified in the given beans definition.
     * <li>Will always take {@code abstract}, {@code scope},
     * {@code lazyInit}, {@code autowireMode}, {@code dependencyCheck},
     * and {@code dependsOn} from the given beans definition.
     * <li>Will add {@code constructorArgumentValues}, {@code propertyValues},
     * {@code methodOverrides} from the given beans definition to existing ones.
     * <li>Will override {@code factoryBeanName}, {@code factoryMethodName},
     * {@code initMethodName}, and {@code destroyMethodName} if specified
     * in the given beans definition.
     * </ul>
     */
    ...
    /**
     * Apply the provided default values to this beans.
    ...
    /**
     * Specify the class for this beans.
     */
    ...
    /**
     * Return the class of the wrapped beans (assuming it is resolved already).
     * @return the beans class (never {@code null})
     * @throws IllegalStateException if the beans definition does not define a beans class,
     * or a specified beans class name has not been resolved into an actual Class yet
     * @see #hasBeanClass()
    ...
    public Class<?> getBeanClass() throws IllegalStateException {
        ...
        if (beanClassObject == null) {
            throw new IllegalStateException("No beans class specified on beans definition");
        }
        if (!(beanClassObject instanceof Class)) {
    ...
    /**
     * Return whether this definition specifies a beans class.
     * @see #getBeanClass()
     * @see #setBeanClass(Class)
     * @see #resolveBeanClass(ClassLoader)
     */
    ...
    /**
     * Determine the class of the wrapped beans, resolving it from a
     * specified class name if necessary. Will also reload a specified
     * Class from its name when called with the beans class already resolved.
     * @param classLoader the ClassLoader to use for resolving a (potential) class name
     * @return the resolved beans class
    ...
    /**
     * Set the name of the target scope for the beans.
     * <p>The default is singleton status, although this is only applied once
     * a beans definition becomes active in the containing factory. A beans
     * definition may eventually inherit its scope from a parent beans definition.
    ...
    /**
     * Return the name of the target scope for the beans.
     */
    @Override
    @Nullable
    ...
    /**
     * Set if this beans is "abstract", i.e. not meant to be instantiated itself but
     * rather just serving as parent for concrete child beans definitions.
     * <p>Default is "false". Specify true to tell the beans factory to not try to
     * instantiate that particular beans in any case.
     */
    ...
    /**
     * Return whether this beans is "abstract", i.e. not meant to be instantiated
     * itself but rather just serving as parent for concrete child beans definitions.
     */
    @Override
    ...
    /**
     * Return the autowire mode as specified in the beans definition.
     */
     ...
     * <p>Note that dependencies are normally expressed through beans properties or
    ...
    /**
     * Return whether this beans has the specified qualifier.
     */
    ...
    /**
     * Copy the qualifiers from the supplied AbstractBeanDefinition to this beans definition.
    ...
    /**
     * Specify a callback for creating an instance of the beans,
     * as an alternative to a declaratively specified factory method.
     * <p>If such a callback is set, it will override any other constructor
     * or factory method metadata. However, beans property population and
    ...
    /**
     * Return a callback for creating an instance of the beans, if any.
     * @since 5.0
     */
    @Nullable
     ...
     * externalized metadata in this beans definition only.
     */
    ...
    /**
     * Specify constructor argument values for this beans.
     */
    ...
    /**
     * Return constructor argument values for this beans (never {@code null}).
     */
    @Override
    ...
    /**
     * Specify property values for this beans, if any.
     */
    ...
    /**
     * Return property values for this beans (never {@code null}).
     */
    @Override
    ...
    /**
     * Specify method overrides for the beans, if any.
     */
    ...
    /**
     * Return if there are method overrides defined for this beans.
     * @since 5.0.2
     */
    ...
    /**
     * Set whether this beans definition is 'synthetic', that is, not defined
     * by the application itself (for example, an infrastructure beans such
    ...
    /**
     * Return whether this beans definition is 'synthetic', that is,
    ...
    /**
     * Set the resource that this beans definition came from
    ...
    /**
     * Return the resource that this beans definition came from.
     */
    @Nullable
    ...
    /**
     * Set a description of the resource that this beans definition
    ...
    /**
     * Validate this beans definition.
        ...
        if (hasMethodOverrides() && getFactoryMethodName() != null) {
            throw new BeanDefinitionValidationException(
                    "Cannot combine factory method with container-generated method overrides: " +
                            "the factory method must create the concrete beans instance.");
        }
        if (hasBeanClass()) {
    ...
    /**
     * Validate and prepare the method overrides defined for this beans.
    ...
    /**
     * Clone this beans definition.
     * To be implemented by concrete subclasses.
     * @return the cloned beans definition object
     */
