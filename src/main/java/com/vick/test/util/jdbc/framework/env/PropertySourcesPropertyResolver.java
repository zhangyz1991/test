...
public class PropertySourcesPropertyResolver extends AbstractPropertyResolver {
     ...
     * @param propertySources the set of {@link com.vick.test.util.jdbc.beans.PropertySource} objects to use
     */
    ...
    /**
     * Log the given key as found in the given {@link com.vick.test.util.jdbc.beans.PropertySource}, resulting in
     * the given value.
