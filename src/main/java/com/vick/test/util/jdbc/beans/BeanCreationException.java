...
public class BeanCreationException extends FatalBeanException {
    ...
    public BeanCreationException(@Nullable String resourceDescription, @Nullable String beanName, String msg) {
        super("Error creating beans with name '" + beanName + "'" +
    ...
    /**
     * Return the name of the beans requested, if any.
     */
    @Nullable
    ...
    /**
     * Add a related cause to this beans creation exception,
     * not being a direct cause of the failure but having occurred
     * earlier in the creation of the same beans instance.
