...
import com.vick.test.util.jdbc.framework.io.SpringFactoriesLoader;
...
public final class CachedIntrospectionResults {
     ...
     * This variant is being used for cache-safe beans classes.
     */
     ...
     * This variant is being used for non-cache-safe beans classes.
     */
    ...
    /**
     * Create CachedIntrospectionResults for the given beans class.
     * @param beanClass the beans class to analyze
    ...
    /** The BeanInfo object for the introspected beans class. */
    ...
    private CachedIntrospectionResults(Class<?> beanClass) throws BeansException {
        try {
            ...
            for (PropertyDescriptor pd : pds) {
                ...
                if (logger.isTraceEnabled()) {
                    logger.trace("Found beans property '" + pd.getName() + "'" +
