...
public abstract class ClassUtils {
    ...
    /**
     * Override the thread context ClassLoader with the environment's beans ClassLoader
     * if necessary, i.e. if the beans ClassLoader is not equivalent to the thread
     ...
     * operations, no beans property methods, no default methods.
