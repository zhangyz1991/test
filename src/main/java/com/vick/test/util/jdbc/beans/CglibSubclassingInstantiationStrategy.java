...
import com.vick.test.util.jdbc.cglib.*;
...
public class CglibSubclassingInstantiationStrategy extends SimpleInstantiationStrategy {
    ...
    private static class CglibSubclassCreator {
        ...
        /**
         * Create an enhanced subclass of the beans class for the provided beans
     ...
     * ensure that CGLIB doesn't generate a distinct class per beans.
     * Identity is based on class and beans definition.
     */
     ...
     * implementation that returns a beans looked up in the container.
     */
