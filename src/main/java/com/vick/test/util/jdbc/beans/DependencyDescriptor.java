...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
     ...
     * @param type the requested beans type
     * @param matchingBeans a map of beans names and corresponding beans
     * instances which have been pre-selected for the given type
     * (qualifiers etc already applied)
     * @return a beans instance to proceed with, or {@code null} for none
    ...
    /**
     * Resolve the specified beans name, as a candidate result of the matching
     * algorithm for this dependency, to a beans instance from the given factory.
     * <p>The default implementation calls {@link BeanFactory#getBean(String)}.
     * Subclasses may provide additional arguments or other customizations.
     * @param beanName the beans name, as a candidate result for this dependency
     * @param requiredType the expected type of the beans (as an assertion)
     * @param beanFactory the associated factory
     * @return the beans instance (never {@code null})
     * @throws BeansException if the beans could not be obtained
     * @since 4.3.2
