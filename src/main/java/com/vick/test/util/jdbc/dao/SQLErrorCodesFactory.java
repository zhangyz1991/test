...
import com.vick.test.util.jdbc.beans.BeansException;
import com.vick.test.util.jdbc.beans.DefaultListableBeanFactory;
import com.vick.test.util.jdbc.beans.XmlBeanDefinitionReader;
