...
public abstract class BeanUtils {
     ...
     * @throws BeanInstantiationException if the beans cannot be instantiated
    ...
    /**
     * Determine the beans property type for the given property from the
     * given classes/interfaces, if possible.
     * @param propertyName the name of the beans property
    ...
    /**
     * Copy the property values of the given source beans into the target beans.
     * <p>Note: The source and target classes do not have to match or even be derived
     * from each other, as long as the properties match. Any beans properties that the
     * source beans exposes but the target beans does not will silently be ignored.
     * <p>This is just a convenience method. For more complex transfer needs,
     * consider using a full BeanWrapper.
     * @param source the source beans
     * @param target the target beans
    ...
    /**
     * Copy the property values of the given source beans into the given target beans,
