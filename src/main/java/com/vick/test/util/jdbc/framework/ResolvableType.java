...
import com.vick.test.util.jdbc.framework.SerializableTypeWrapper.FieldTypeProvider;
import com.vick.test.util.jdbc.framework.SerializableTypeWrapper.MethodParameterTypeProvider;
import com.vick.test.util.jdbc.framework.SerializableTypeWrapper.TypeProvider;
...
public class ResolvableType implements Serializable {
    ...
    private boolean isAssignableFrom(ResolvableType other, @Nullable Map<Type, Type> matchedBefore) {
        ...
        // DatabaseTest assignability check about to follow
